...
public class ThongKey implements ExampleChart<PieChart>{
    public static long tongthu;
    public static long tongchi;

    public void main(){
        ExampleChart<PieChart> exampleChart=new ThongKey();
    ...
    public PieChart getChart(){
        ...
        // Series
        chart.addSeries("Tổng chi ",getThu());
        chart.addSeries("Tổng thu",getChi());
        return chart;
    }
